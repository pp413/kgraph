...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "kgraph.utils.corrupt"
}
END: Cython Metadata */
...
#define __PYX_HAVE__kgraph__utils__corrupt
#define __PYX_HAVE_API__kgraph__utils__corrupt
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
static __pyx_ctuple_int__and_int __pyx_f_6kgraph_5utils_7corrupt_find_target_id(__pyx_t_6kgraph_5utils_6memory_Pair *, int *, int *, int, int); /*proto*/
...
static int __pyx_f_6kgraph_5utils_7corrupt_find(__pyx_t_6kgraph_5utils_6memory_DataStruct *, int, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "kgraph.utils.corrupt"
extern int __pyx_module_is_main_kgraph__utils__corrupt;
int __pyx_module_is_main_kgraph__utils__corrupt = 0;

/* Implementation of 'kgraph.utils.corrupt' */
...
static __pyx_ctuple_int__and_int __pyx_f_6kgraph_5utils_7corrupt_find_target_id(__pyx_t_6kgraph_5utils_6memory_Pair *__pyx_v_ptr, int *__pyx_v_pair_lef, int *__pyx_v_pair_rig, int __pyx_v_ent, int __pyx_v_rel) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_ent_id;
 ...
 *     i = pair_lef[ent_id]
 */
  __pyx_v_ent_id = ((int)__pyx_v_ent);

  /* "kgraph/utils/corrupt.pyx":10
 *         int ent_id = <int>ent
 * 
 *     i = pair_lef[ent_id]             # <<<<<<<<<<<<<<
 *     j = pair_rig[ent_id]
 * 
 */
  __pyx_v_i = (__pyx_v_pair_lef[__pyx_v_ent_id]);

  /* "kgraph/utils/corrupt.pyx":11
 * 
 *     i = pair_lef[ent_id]
 *     j = pair_rig[ent_id]             # <<<<<<<<<<<<<<
 * 
 *     while i < j:
 */
  __pyx_v_j = (__pyx_v_pair_rig[__pyx_v_ent_id]);

  /* "kgraph/utils/corrupt.pyx":13
 *     j = pair_rig[ent_id]
 * 
 *     while i < j:             # <<<<<<<<<<<<<<
 *         k = i + ((j-i) >> 1)
 ...
 *             i = k
 */
    __pyx_v_k = (__pyx_v_i + ((__pyx_v_j - __pyx_v_i) >> 1));

    /* "kgraph/utils/corrupt.pyx":15
 *     while i < j:
 *         k = i + ((j-i) >> 1)
 *         if rel == ptr[k].rel:             # <<<<<<<<<<<<<<
 *             i = k
 *             break
 */
    __pyx_t_1 = ((__pyx_v_rel == (__pyx_v_ptr[__pyx_v_k]).rel) != 0);
    if (__pyx_t_1) {

      /* "kgraph/utils/corrupt.pyx":16
 *         k = i + ((j-i) >> 1)
 *         if rel == ptr[k].rel:
 *             i = k             # <<<<<<<<<<<<<<
 *             break
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_rel != (__pyx_v_ptr[__pyx_v_i]).rel) != 0);
  if (__pyx_t_1) {

    /* "kgraph/utils/corrupt.pyx":23
 *             i = k + 1
 *     if rel != ptr[i].rel:
 *         return -1, -1             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_1 = ((((__pyx_v_ptr[__pyx_v_i]).rig_id - (__pyx_v_ptr[__pyx_v_i]).lef_id) < 0) != 0);
  if (__pyx_t_1) {

    /* "kgraph/utils/corrupt.pyx":26
 * 
 *     if ptr[i].rig_id - ptr[i].lef_id < 0:
 *         return 0, -1             # <<<<<<<<<<<<<<
 * 
 ...
 * cdef int corrupt_tail_c(DataStruct* train_data, int tId, int head, int rel, int entityTotal, int flag) nogil:
 */
  __pyx_t_2.f0 = (__pyx_v_ptr[__pyx_v_i]).lef_id;
  __pyx_t_2.f1 = (__pyx_v_ptr[__pyx_v_i]).rig_id;
  __pyx_r = __pyx_t_2;
  goto __pyx_L0;
...
static int __pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_c(__pyx_t_6kgraph_5utils_6memory_DataStruct *__pyx_v_train_data, int __pyx_v_tId, int __pyx_v_head, int __pyx_v_rel, int __pyx_v_entityTotal, int __pyx_v_flag) {
  int __pyx_v_lef;
  int __pyx_v_rig;
  int __pyx_v_mid;
  int __pyx_v_ll;
 ...
 * 
 */
  __pyx_t_1 = __pyx_f_6kgraph_5utils_7corrupt_find_target_id(__pyx_v_train_data->pair_tail_idx, __pyx_v_train_data->pair_lef_head, __pyx_v_train_data->pair_rig_head, __pyx_v_head, __pyx_v_rel);
  __pyx_t_2 = __pyx_t_1.f0;
  __pyx_t_3 = __pyx_t_1.f1;
  __pyx_v_lef = __pyx_t_2;
  __pyx_v_rig = __pyx_t_3;

  /* "kgraph/utils/corrupt.pyx":36
 * 
 *     lef, rig = find_target_id(train_data.pair_tail_idx, train_data.pair_lef_head, train_data.pair_rig_head, head, rel)
 *     tmp = <int>rand_max(tId, <long>(entityTotal - (rig - lef + 1)), flag)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_tmp = ((int)__pyx_f_6kgraph_5utils_6memory_rand_max(__pyx_v_tId, ((long)(__pyx_v_entityTotal - ((__pyx_v_rig - __pyx_v_lef) + 1))), __pyx_v_flag));

  /* "kgraph/utils/corrupt.pyx":38
 *     tmp = <int>rand_max(tId, <long>(entityTotal - (rig - lef + 1)), flag)
 * 
 *     if tmp < train_data.data_head[lef].tail:             # <<<<<<<<<<<<<<
 *         return tmp
 ...
 */
  __pyx_t_4 = ((__pyx_v_tmp < (__pyx_v_train_data->data_head[__pyx_v_lef]).tail) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":39
 * 
 *     if tmp < train_data.data_head[lef].tail:
 *         return tmp             # <<<<<<<<<<<<<<
 *     if tmp + rig - lef + 1 > train_data.data_head[rig].tail:
 ...
 * 
 */
  __pyx_t_4 = (((((__pyx_v_tmp + __pyx_v_rig) - __pyx_v_lef) + 1) > (__pyx_v_train_data->data_head[__pyx_v_rig]).tail) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":41
 *         return tmp
 *     if tmp + rig - lef + 1 > train_data.data_head[rig].tail:
 *         return tmp + rig - lef + 1             # <<<<<<<<<<<<<<
 * 
 *     ll = lef
 */
    __pyx_r = (((__pyx_v_tmp + __pyx_v_rig) - __pyx_v_lef) + 1);
    goto __pyx_L0;
 ...
 *     while ll < rr:
 */
  __pyx_v_ll = __pyx_v_lef;

  /* "kgraph/utils/corrupt.pyx":44
 * 
 *     ll = lef
 *     rr = rig             # <<<<<<<<<<<<<<
 *     while ll < rr:
 *         mid = ll + ((rr - ll) >> 1)
 */
  __pyx_v_rr = __pyx_v_rig;

  /* "kgraph/utils/corrupt.pyx":45
 *     ll = lef
 *     rr = rig
 *     while ll < rr:             # <<<<<<<<<<<<<<
 *         mid = ll + ((rr - ll) >> 1)
 ...
 */
  while (1) {
    __pyx_t_4 = ((__pyx_v_ll < __pyx_v_rr) != 0);
    if (!__pyx_t_4) break;

    /* "kgraph/utils/corrupt.pyx":46
 *     rr = rig
 *     while ll < rr:
 *         mid = ll + ((rr - ll) >> 1)             # <<<<<<<<<<<<<<
 *         if tmp == train_data.data_head[mid].tail:
 *             ll = mid
 */
    __pyx_v_mid = (__pyx_v_ll + ((__pyx_v_rr - __pyx_v_ll) >> 1));

    /* "kgraph/utils/corrupt.pyx":47
 *     while ll < rr:
 *         mid = ll + ((rr - ll) >> 1)
 *         if tmp == train_data.data_head[mid].tail:             # <<<<<<<<<<<<<<
 *             ll = mid
 *             break
 */
    __pyx_t_4 = ((__pyx_v_tmp == (__pyx_v_train_data->data_head[__pyx_v_mid]).tail) != 0);
    if (__pyx_t_4) {

      /* "kgraph/utils/corrupt.pyx":48
 *         mid = ll + ((rr - ll) >> 1)
 *         if tmp == train_data.data_head[mid].tail:
 *             ll = mid             # <<<<<<<<<<<<<<
 *             break
 *         if tmp < train_data.data_head[mid].tail:
 */
      __pyx_v_ll = __pyx_v_mid;

      /* "kgraph/utils/corrupt.pyx":49
 *         if tmp == train_data.data_head[mid].tail:
 *             ll = mid
 *             break             # <<<<<<<<<<<<<<
 *         if tmp < train_data.data_head[mid].tail:
 ...
 */
    /*else*/ {
      __pyx_v_ll = (__pyx_v_mid + 1);
    }
    __pyx_L8:;
  }
  __pyx_L6_break:;

  /* "kgraph/utils/corrupt.pyx":54
 *         else:
 *             ll = mid + 1
 *     if tmp == train_data.data_head[ll].tail:             # <<<<<<<<<<<<<<
 *         return corrupt_tail_c(train_data, tId, head, rel, entityTotal, flag)
 *     else:
 */
  __pyx_t_4 = ((__pyx_v_tmp == (__pyx_v_train_data->data_head[__pyx_v_ll]).tail) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":55
 *             ll = mid + 1
 *     if tmp == train_data.data_head[ll].tail:
 *         return corrupt_tail_c(train_data, tId, head, rel, entityTotal, flag)             # <<<<<<<<<<<<<<
 *     else:
 * 
 */
    __pyx_r = __pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_c(__pyx_v_train_data, __pyx_v_tId, __pyx_v_head, __pyx_v_rel, __pyx_v_entityTotal, __pyx_v_flag);
    goto __pyx_L0;
 ...
 */
  /*else*/ {
    __pyx_r = ((__pyx_v_tmp + __pyx_v_ll) - __pyx_v_lef);
    goto __pyx_L0;
  }
...
static int __pyx_f_6kgraph_5utils_7corrupt_corrupt_head_c(__pyx_t_6kgraph_5utils_6memory_DataStruct *__pyx_v_train_data, int __pyx_v_tId, int __pyx_v_tail, int __pyx_v_rel, int __pyx_v_entityTotal, int __pyx_v_flag) {
  int __pyx_v_lef;
  int __pyx_v_rig;
  int __pyx_v_mid;
  int __pyx_v_ll;
 ...
 * 
 */
  __pyx_t_1 = __pyx_f_6kgraph_5utils_7corrupt_find_target_id(__pyx_v_train_data->pair_head_idx, __pyx_v_train_data->pair_lef_tail, __pyx_v_train_data->pair_rig_tail, __pyx_v_tail, __pyx_v_rel);
  __pyx_t_2 = __pyx_t_1.f0;
  __pyx_t_3 = __pyx_t_1.f1;
  __pyx_v_lef = __pyx_t_2;
  __pyx_v_rig = __pyx_t_3;

  /* "kgraph/utils/corrupt.pyx":66
 * 
 *     lef, rig = find_target_id(train_data.pair_head_idx, train_data.pair_lef_tail, train_data.pair_rig_tail, tail, rel)
 *     tmp = <int>rand_max(tId, <long>(entityTotal - (rig - lef + 1)), flag)             # <<<<<<<<<<<<<<
 * 
 ...
 *         return tmp
 */
  __pyx_t_4 = ((__pyx_v_tmp < (__pyx_v_train_data->data_tail[__pyx_v_lef]).head) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":70
 *     if tmp < train_data.data_tail[lef].head:
 * 
 *         return tmp             # <<<<<<<<<<<<<<
 ...
 *         return tmp + rig - lef + 1
 */
  __pyx_t_4 = (((((__pyx_v_tmp + __pyx_v_rig) - __pyx_v_lef) + 1) > (__pyx_v_train_data->data_tail[__pyx_v_rig]).head) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":73
 *     if tmp + rig - lef + 1 > train_data.data_tail[rig].head:
 * 
 *         return tmp + rig - lef + 1             # <<<<<<<<<<<<<<
 * 
 ...
 *             break
 */
    __pyx_t_4 = ((__pyx_v_tmp == (__pyx_v_train_data->data_tail[__pyx_v_mid]).head) != 0);
    if (__pyx_t_4) {

      /* "kgraph/utils/corrupt.pyx":80
 *         mid = ll + ((rr - ll) >> 1)
 *         if tmp == train_data.data_tail[mid].head:
 *             ll = mid             # <<<<<<<<<<<<<<
 *             break
 ...
 *     else:
 */
  __pyx_t_4 = ((__pyx_v_tmp == (__pyx_v_train_data->data_tail[__pyx_v_ll]).head) != 0);
  if (__pyx_t_4) {

    /* "kgraph/utils/corrupt.pyx":87
 *             ll = mid + 1
 *     if tmp == train_data.data_tail[ll].head:
 *         return corrupt_head_c(train_data, tId, tail, rel, entityTotal, flag)             # <<<<<<<<<<<<<<
 *     else:
 *         return tmp + ll - lef
 */
    __pyx_r = __pyx_f_6kgraph_5utils_7corrupt_corrupt_head_c(__pyx_v_train_data, __pyx_v_tId, __pyx_v_tail, __pyx_v_rel, __pyx_v_entityTotal, __pyx_v_flag);
    goto __pyx_L0;
...
static int __pyx_f_6kgraph_5utils_7corrupt_find(__pyx_t_6kgraph_5utils_6memory_DataStruct *__pyx_v_ptr, int __pyx_v_head, int __pyx_v_rel, int __pyx_v_tail) {
  int __pyx_v_l;
  int __pyx_v_r;
  int __pyx_v_mid;
  int __pyx_r;
 ...
 *         mid = l + ((r - l) >> 1)
 */
  __pyx_t_1 = __pyx_v_ptr->data_size;
  __pyx_v_r = __pyx_t_1;

  /* "kgraph/utils/corrupt.pyx":95
 *     l = 0
 *     r = ptr.data_size
 *     while l < r:             # <<<<<<<<<<<<<<
 *         mid = l + ((r - l) >> 1)
 ...
 *             l = mid
 */
    __pyx_v_mid = (__pyx_v_l + ((__pyx_v_r - __pyx_v_l) >> 1));

    /* "kgraph/utils/corrupt.pyx":97
 *     while l < r:
 *         mid = l + ((r - l) >> 1)
 *         if (head == ptr.data_head[mid].head) or (head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel) or(head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel and tail == ptr.data_head[mid].tail):             # <<<<<<<<<<<<<<
 *             l = mid
 *             break
 */
    __pyx_t_3 = ((__pyx_v_head == (__pyx_v_ptr->data_head[__pyx_v_mid]).head) != 0);
    if (!__pyx_t_3) {
    } else {
      __pyx_t_2 = __pyx_t_3;
    ...
    __pyx_t_3 = ((__pyx_v_rel == (__pyx_v_ptr->data_head[__pyx_v_mid]).rel) != 0);
    if (!__pyx_t_3) {
    } else {
      __pyx_t_2 = __pyx_t_3;
      goto __pyx_L6_bool_binop_done;
    ...
    __pyx_t_3 = ((__pyx_v_tail == (__pyx_v_ptr->data_head[__pyx_v_mid]).tail) != 0);
    __pyx_t_2 = __pyx_t_3;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_2) {

      /* "kgraph/utils/corrupt.pyx":98
 *         mid = l + ((r - l) >> 1)
 *         if (head == ptr.data_head[mid].head) or (head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel) or(head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel and tail == ptr.data_head[mid].tail):
 *             l = mid             # <<<<<<<<<<<<<<
 *             break
 *         if (head < ptr.data_head[mid].head) or (head == ptr.data_head[mid].head and rel < ptr.data_head[mid].rel) or (head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel and tail < ptr.data_head[mid].tail):
 */
      __pyx_v_l = __pyx_v_mid;

      /* "kgraph/utils/corrupt.pyx":99
 *         if (head == ptr.data_head[mid].head) or (head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel) or(head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel and tail == ptr.data_head[mid].tail):
 *             l = mid
 *             break             # <<<<<<<<<<<<<<
 *         if (head < ptr.data_head[mid].head) or (head == ptr.data_head[mid].head and rel < ptr.data_head[mid].rel) or (head == ptr.data_head[mid].head and rel == ptr.data_head[mid].rel and tail < ptr.data_head[mid].tail):
 ...
 */
    /*else*/ {
      __pyx_v_l = (__pyx_v_mid + 1);
    }
    __pyx_L12:;
  }
  __pyx_L4_break:;

  /* "kgraph/utils/corrupt.pyx":105
 *             l = mid + 1
 * 
 *     if (head == ptr.data_head[l].head and rel == ptr.data_head[l].rel and tail == ptr.data_head[l].tail):             # <<<<<<<<<<<<<<
 *         return 1
 *     else:
 */
  __pyx_t_3 = ((__pyx_v_head == (__pyx_v_ptr->data_head[__pyx_v_l]).head) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
    goto __pyx_L20_bool_binop_done;
  }
  __pyx_t_3 = ((__pyx_v_rel == (__pyx_v_ptr->data_head[__pyx_v_l]).rel) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
    goto __pyx_L20_bool_binop_done;
  }
  __pyx_t_3 = ((__pyx_v_tail == (__pyx_v_ptr->data_head[__pyx_v_l]).tail) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L20_bool_binop_done:;
  if (__pyx_t_2) {

    /* "kgraph/utils/corrupt.pyx":106
 * 
 *     if (head == ptr.data_head[l].head and rel == ptr.data_head[l].rel and tail == ptr.data_head[l].tail):
 *         return 1             # <<<<<<<<<<<<<<
 *     else:
...
static int __pyx_f_6kgraph_5utils_7corrupt_corrupt_head_with_constrain(int __pyx_v_tId, __pyx_t_6kgraph_5utils_6memory_DataStruct *__pyx_v_ptr, __pyx_t_6kgraph_5utils_6memory_Constrain *__pyx_v_constrain, int __pyx_v_head, int __pyx_v_rel, int __pyx_v_entityTotal) {
  int __pyx_v_loop;
  int __pyx_v_tail;
  int __pyx_r;
  int __pyx_t_1;

  /* "kgraph/utils/corrupt.pyx":114
 *     cdef int loop
 *     cdef int tail
 *     loop = 0             # <<<<<<<<<<<<<<
 *     while True:
 ...
 *             return tail
 */
    __pyx_v_tail = ((int)__pyx_f_6kgraph_5utils_6memory_rand64(((long)(__pyx_v_constrain->left_id_of_tails_of_relation[__pyx_v_rel])), ((long)((__pyx_v_constrain->right_id_of_tails_of_relation[__pyx_v_rel]) + 1))));

    /* "kgraph/utils/corrupt.pyx":117
 *     while True:
 *         tail = <int>rand64(<long>constrain.left_id_of_tails_of_relation[rel], <long>(constrain.right_id_of_tails_of_relation[rel]+1))
 *         if not find(ptr, head, rel, tail):             # <<<<<<<<<<<<<<
 *             return tail
 *         else:
 */
    __pyx_t_1 = ((!(__pyx_f_6kgraph_5utils_7corrupt_find(__pyx_v_ptr, __pyx_v_head, __pyx_v_rel, __pyx_v_tail) != 0)) != 0);
    if (__pyx_t_1) {

      /* "kgraph/utils/corrupt.pyx":118
 *         tail = <int>rand64(<long>constrain.left_id_of_tails_of_relation[rel], <long>(constrain.right_id_of_tails_of_relation[rel]+1))
 *         if not find(ptr, head, rel, tail):
 *             return tail             # <<<<<<<<<<<<<<
 *         else:
 ...
 * 
 */
      __pyx_t_1 = ((__pyx_v_loop > 0x3E8) != 0);
      if (__pyx_t_1) {

        /* "kgraph/utils/corrupt.pyx":122
 *             loop += 1
 *             if loop > 1000:
 *                 return corrupt_tail_c(ptr, tId, head, rel, entityTotal, 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_r = __pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_c(__pyx_v_ptr, __pyx_v_tId, __pyx_v_head, __pyx_v_rel, __pyx_v_entityTotal, 1);
        goto __pyx_L0;
...
static int __pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_with_constrain(int __pyx_v_tId, __pyx_t_6kgraph_5utils_6memory_DataStruct *__pyx_v_ptr, __pyx_t_6kgraph_5utils_6memory_Constrain *__pyx_v_constrain, int __pyx_v_tail, int __pyx_v_rel, int __pyx_v_entityTotal) {
  int __pyx_v_loop;
  int __pyx_v_head;
  int __pyx_r;
  int __pyx_t_1;

  /* "kgraph/utils/corrupt.pyx":127
 *     cdef int loop
 *     cdef int head
 *     loop = 0             # <<<<<<<<<<<<<<
 *     while True:
 ...
 *             return head
 */
    __pyx_v_head = ((int)__pyx_f_6kgraph_5utils_6memory_rand64(((long)(__pyx_v_constrain->left_id_of_heads_of_relation[__pyx_v_rel])), ((long)((__pyx_v_constrain->right_id_of_heads_of_relation[__pyx_v_rel]) + 1))));

    /* "kgraph/utils/corrupt.pyx":130
 *     while True:
 *         head = <int>rand64(<long>constrain.left_id_of_heads_of_relation[rel], <long>(constrain.right_id_of_heads_of_relation[rel]+1))
 *         if not find(ptr, head, rel, tail):             # <<<<<<<<<<<<<<
 *             return head
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "kgraph/utils/corrupt.pyx":135
 *             loop += 1
 *             if loop > 1000:
 *                 return corrupt_head_c(ptr, tId, tail, rel, entityTotal, 1)             # <<<<<<<<<<<<<<
 */
        __pyx_r = __pyx_f_6kgraph_5utils_7corrupt_corrupt_head_c(__pyx_v_ptr, __pyx_v_tId, __pyx_v_tail, __pyx_v_rel, __pyx_v_entityTotal, 1);
        goto __pyx_L0;
 ...
 * 
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 148, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_10 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 176, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_Raise(__pyx_t_10, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *         info.len = self.len
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__5, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 192, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 418, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 *             if len(self.view.format) == 1:
 */
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__9, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 495, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_6);
 ...
 *         if flags & PyBUF_ND:
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__10, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 520, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__11, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 570, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyNumber_Multiply(__pyx_tuple__12, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 577, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
 ...
 */
      /*else*/ {
        __pyx_t_9 = __Pyx_PyList_Append(__pyx_v_result, __pyx_slice__15); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(0, 685, __pyx_L1_error)
      }
      __pyx_L7:;
 ...
 * 
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__16, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 703, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "kgraph.utils.corrupt.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "kgraph.utils.corrupt.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "kgraph.utils.corrupt.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "kgraph.utils.corrupt._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_corrupt(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_corrupt},
  {0, NULL}
};
#endif
 ...
 *         if itemsize <= 0:
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Empty_shape_tuple_for_cython_arr); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 133, __pyx_L1_error)
 ...
 *         if not isinstance(format, bytes):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_itemsize_0_for_cython_array); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 136, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_shape_and_str); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 148, __pyx_L1_error)
 ...
 *             if self.dtype_is_object:
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_array_data); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 176, __pyx_L1_error)
 ...
 *         info.len = self.len
 */
  __pyx_tuple__5 = PyTuple_Pack(1, __pyx_kp_s_Can_only_create_a_buffer_that_is); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 192, __pyx_L1_error)
 ...
 *         have_slices, index = _unellipsify(index, self.view.ndim)
 */
  __pyx_tuple__8 = PyTuple_Pack(1, __pyx_kp_s_Cannot_assign_to_read_only_memor); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 418, __pyx_L1_error)
 ...
 *             if len(self.view.format) == 1:
 */
  __pyx_tuple__9 = PyTuple_Pack(1, __pyx_kp_s_Unable_to_convert_item_to_object); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 495, __pyx_L1_error)
 ...
 *         if flags & PyBUF_ND:
 */
  __pyx_tuple__10 = PyTuple_Pack(1, __pyx_kp_s_Cannot_create_writable_memory_vi); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 520, __pyx_L1_error)
 ...
 *         return tuple([stride for stride in self.view.strides[:self.view.ndim]])
 */
  __pyx_tuple__11 = PyTuple_Pack(1, __pyx_kp_s_Buffer_view_does_not_expose_stri); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 570, __pyx_L1_error)
 ...
 *         return tuple([suboffset for suboffset in self.view.suboffsets[:self.view.ndim]])
 */
  __pyx_tuple__12 = PyTuple_New(1); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 577, __pyx_L1_error)
 ...
 *             else:
 */
  __pyx_slice__15 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__15)) __PYX_ERR(0, 682, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__16 = PyTuple_Pack(1, __pyx_kp_s_Indirect_dimensions_not_supporte); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(0, 703, __pyx_L1_error)
 ...
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct_or_indirect); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 286, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 287, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_strided_and_indirect); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 288, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_direct); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 291, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__23 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_indirect); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 292, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("find_target_id", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_find_target_id, "__pyx_ctuple_int__and_int (__pyx_t_6kgraph_5utils_6memory_Pair *, int *, int *, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("corrupt_tail_c", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_c, "int (__pyx_t_6kgraph_5utils_6memory_DataStruct *, int, int, int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("corrupt_head_c", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_corrupt_head_c, "int (__pyx_t_6kgraph_5utils_6memory_DataStruct *, int, int, int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("find", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_find, "int (__pyx_t_6kgraph_5utils_6memory_DataStruct *, int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("corrupt_head_with_constrain", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_corrupt_head_with_constrain, "int (int, __pyx_t_6kgraph_5utils_6memory_DataStruct *, __pyx_t_6kgraph_5utils_6memory_Constrain *, int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("corrupt_tail_with_constrain", (void (*)(void))__pyx_f_6kgraph_5utils_7corrupt_corrupt_tail_with_constrain, "int (int, __pyx_t_6kgraph_5utils_6memory_DataStruct *, __pyx_t_6kgraph_5utils_6memory_Constrain *, int, int, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  /*--- Type import code ---*/
  __pyx_t_1 = PyImport_ImportModule("kgraph.utils.memory"); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_6kgraph_5utils_6memory_Memory = __Pyx_ImportType(__pyx_t_1, "kgraph.utils.memory", "Memory", sizeof(struct __pyx_obj_6kgraph_5utils_6memory_Memory), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6kgraph_5utils_6memory_Memory) __PYX_ERR(2, 70, __pyx_L1_error)
  __pyx_ptype_6kgraph_5utils_6memory_Data = __Pyx_ImportType(__pyx_t_1, "kgraph.utils.memory", "Data", sizeof(struct __pyx_obj_6kgraph_5utils_6memory_Data), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6kgraph_5utils_6memory_Data) __PYX_ERR(2, 75, __pyx_L1_error)
  __pyx_vtabptr_6kgraph_5utils_6memory_Data = (struct __pyx_vtabstruct_6kgraph_5utils_6memory_Data*)__Pyx_GetVtable(__pyx_ptype_6kgraph_5utils_6memory_Data->tp_dict); if (unlikely(!__pyx_vtabptr_6kgraph_5utils_6memory_Data)) __PYX_ERR(2, 75, __pyx_L1_error)
  __pyx_ptype_6kgraph_5utils_6memory_PyMalloc = __Pyx_ImportType(__pyx_t_1, "kgraph.utils.memory", "PyMalloc", sizeof(struct __pyx_obj_6kgraph_5utils_6memory_PyMalloc), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6kgraph_5utils_6memory_PyMalloc) __PYX_ERR(2, 91, __pyx_L1_error)
  __pyx_vtabptr_6kgraph_5utils_6memory_PyMalloc = (struct __pyx_vtabstruct_6kgraph_5utils_6memory_PyMalloc*)__Pyx_GetVtable(__pyx_ptype_6kgraph_5utils_6memory_PyMalloc->tp_dict); if (unlikely(!__pyx_vtabptr_6kgraph_5utils_6memory_PyMalloc)) __PYX_ERR(2, 91, __pyx_L1_error)
  __pyx_ptype_6kgraph_5utils_6memory_PyFree = __Pyx_ImportType(__pyx_t_1, "kgraph.utils.memory", "PyFree", sizeof(struct __pyx_obj_6kgraph_5utils_6memory_PyFree), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6kgraph_5utils_6memory_PyFree) __PYX_ERR(2, 95, __pyx_L1_error)
  __pyx_vtabptr_6kgraph_5utils_6memory_PyFree = (struct __pyx_vtabstruct_6kgraph_5utils_6memory_PyFree*)__Pyx_GetVtable(__pyx_ptype_6kgraph_5utils_6memory_PyFree->tp_dict); if (unlikely(!__pyx_vtabptr_6kgraph_5utils_6memory_PyFree)) __PYX_ERR(2, 95, __pyx_L1_error)
  __pyx_ptype_6kgraph_5utils_6memory_MemoryPool = __Pyx_ImportType(__pyx_t_1, "kgraph.utils.memory", "MemoryPool", sizeof(struct __pyx_obj_6kgraph_5utils_6memory_MemoryPool), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6kgraph_5utils_6memory_MemoryPool) __PYX_ERR(2, 103, __pyx_L1_error)
  __pyx_vtabptr_6kgraph_5utils_6memory_MemoryPool = (struct __pyx_vtabstruct_6kgraph_5utils_6memory_MemoryPool*)__Pyx_GetVtable(__pyx_ptype_6kgraph_5utils_6memory_MemoryPool->tp_dict); if (unlikely(!__pyx_vtabptr_6kgraph_5utils_6memory_MemoryPool)) __PYX_ERR(2, 103, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __Pyx_modinit_variable_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("kgraph.utils.memory"); if (!__pyx_t_1) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "WARN_ZERO_ALLOC", (void **)&__pyx_vp_6kgraph_5utils_6memory_WARN_ZERO_ALLOC, "int") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "next_random", (void **)&__pyx_vp_6kgraph_5utils_6memory_next_random, "unsigned PY_LONG_LONG *") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "id_random", (void **)&__pyx_vp_6kgraph_5utils_6memory_id_random, "unsigned PY_LONG_LONG *") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "global_random_memory_pool", (void **)&__pyx_vp_6kgraph_5utils_6memory_global_random_memory_pool, "struct __pyx_obj_6kgraph_5utils_6memory_MemoryPool *") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("kgraph.utils.memory"); if (!__pyx_t_1) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "rand_max", (void (**)(void))&__pyx_f_6kgraph_5utils_6memory_rand_max, "long (int const , long const , int const )") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "rand64", (void (**)(void))&__pyx_f_6kgraph_5utils_6memory_rand64, "long (long const , long const )") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcorrupt(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcorrupt(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_corrupt(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_corrupt(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_corrupt(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'corrupt' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_corrupt(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("corrupt", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kgraph__utils__corrupt) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kgraph.utils.corrupt")) {
      if (unlikely(PyDict_SetItemString(modules, "kgraph.utils.corrupt", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 286, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 287, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 288, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 291, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__23, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 292, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kgraph.utils.corrupt", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kgraph.utils.corrupt");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
